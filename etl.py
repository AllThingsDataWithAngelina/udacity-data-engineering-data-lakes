...
def process_log_data(spark, input_data, output_data):
    ...
    artists_table = df.selectExpr("userId as user_id",
    ...
    artists_table.write.parquet(output_data + "users_table.parquet",
                              mode = "overwrite")
    ...
    songplays_table = song_df.createOrReplaceTempView("song_data")
...
def main():
    ...
    output_data = "s3a://my-udacity-datalake-bucket/"
